...
{ 
	...
	I2C_Send7bitAddress(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), 0X1A,((uint8_t)0x00));

	if(I2C_ReceiveData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))))return 1;	

	I2C_Send7bitAddress(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)),( (reg<<1) | (val>>8) ),((uint8_t)0x00));
	if(I2C_ReceiveData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))))return 2;	

	I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)),(val&0XFF));
	if(I2C_ReceiveData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))))return 3;	
