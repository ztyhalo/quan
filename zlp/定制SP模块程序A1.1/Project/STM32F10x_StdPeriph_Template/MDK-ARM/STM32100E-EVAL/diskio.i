#line 1 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.c"
...
#line 2 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.c"
...
#line 3 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.c"
...
#line 4 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.c"
...
#line 6 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.c"
#line 7 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.c"
#line 8 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.c"
...
DRESULT disk_read(BYTE drv,BYTE *buff,DWORD sector,BYTE count)
{
	...
	while (reTryTime)
	{
		if(count == 1)
		{
			if(SD_ReadBlock((uint8_t*)buff, sector, 512U) != SD_OK)
			{
				SD_Init();
				reTryTime--;
		    	continue;
		...
		{
			if(SD_ReadMultiBlocks((uint8_t*)buff, sector, 512U, count) != SD_OK)
			{
				SD_Init();
				reTryTime--;
			    continue;
...
DRESULT disk_write (BYTE drv,const BYTE *buff,DWORD sector,BYTE count)
{
	...
	while (reTryTime)
	{
		if(count == 1)
		{
			if(SD_WriteBlock((uint8_t*)buff, sector, 512U) != SD_OK)
			{
				SD_Init();
				reTryTime--;
			    continue;
		...
		{
			if(SD_WriteMultiBlocks((uint8_t*)buff, sector, 512U, count) != SD_OK)
			{
				SD_Init();
				reTryTime--;
			    continue;
...
DSTATUS disk_fatRecover(BYTE drv)
{
	...
	SD_ReadBlock(TestBuffer, 6, 512);
    SD_WaitReadOperation();	                 
    errorstatus = SD_WaitTransferOK();       
    ...
    SD_WriteBlock(TestBuffer, 0, 512);
    ...
    SD_WriteBlock(TestBuffer, 1, 512);
    SD_WaitWriteOperation();                 
    errorstatus = SD_WaitTransferOK();       
    ...
    SD_WriteBlock(TestBuffer, 2, 512);
    SD_WaitWriteOperation();                 
    errorstatus = SD_WaitTransferOK();       
