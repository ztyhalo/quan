...
OS_STK	TaskIOINPUTStk[0x100];			  
OS_STK	TaskIOOUTPUTStk[0x100];			
OS_STK	TaskLCDOUTPUTStk[0x100];			
OS_STK	TASK_START_STK[0x100];			          
...
void TaskStart(void * pdata)
{
	...
	SysTickConfiguartion();					              	

	{cpu_sr = OS_CPU_SR_Save();};   
	OSTaskCreateExt(TaskIOINPUT,					             
					(void *)0,
					&TaskIOINPUTStk[0x100 - 1],
					7,
					1,
					&TaskIOINPUTStk[0],
					0x100,
	...
	OSTaskCreateExt(TaskIOOUTPUT,					             
					(void *)0,
					&TaskIOOUTPUTStk[0x100 - 1],
					8,
					2,
					&TaskIOOUTPUTStk[0],
					0x100,
	...
	OSTaskCreateExt(LCDOUTPUT,					             
					(void *)0,
					&TaskLCDOUTPUTStk[0x100 - 1],
					8,
					3,
					&TaskLCDOUTPUTStk[0],
					0x100,
