#line 1 "..\\..\\..\\OS\\uCOS-II\\Ports\\os_dbg.c"
...
#line 26 "..\\..\\..\\OS\\uCOS-II\\Ports\\os_dbg.c"
  ...
  INT16U  const  OSDebugEn          = 1;                 



  INT32U  const  OSEndiannessTest   = 0x12345678L;                 

  INT16U  const  OSEventMax         = 10;               
  INT16U  const  OSEventNameSize    = 16;          
  INT16U  const  OSEventEn          = (((0 > 0) && (4 > 0)) || (1 > 0) || (1 > 0) || (0 > 0));
  ...
  INT16U  const  OSFlagMax          = 5;
  INT16U  const  OSFlagNameSize     = 16;           

  INT16U  const  OSLowestPrio       = 31;

  INT16U  const  OSMboxEn           = 1;

  INT16U  const  OSMemEn            = 0;
  INT16U  const  OSMemMax           = 5;             
  INT16U  const  OSMemNameSize      = 16;            
  ...
  INT16U  const  OSMutexEn          = 0;

  INT16U  const  OSPtrSize          = sizeof(void *);              

  INT16U  const  OSQEn              = 0;
  INT16U  const  OSQMax             = 4;                   
  ...
  INT16U  const  OSRdyTblSize       = ((31) / 8 + 1);             

  INT16U  const  OSSemEn            = 1;

  INT16U  const  OSStkWidth         = sizeof(OS_STK);              

  INT16U  const  OSTaskCreateEn     = 1;
  INT16U  const  OSTaskCreateExtEn  = 1;
  INT16U  const  OSTaskDelEn        = 1;
  INT16U  const  OSTaskIdleStkSize  = 128;
  INT16U  const  OSTaskProfileEn    = 1;
  INT16U  const  OSTaskMax          = 20 + 2u;   
  INT16U  const  OSTaskNameSize     = 25;               
  INT16U  const  OSTaskStatEn       = 1;
  INT16U  const  OSTaskStatStkSize  = 128;
  INT16U  const  OSTaskStatStkChkEn = 1;
  INT16U  const  OSTaskSwHookEn     = 1;

  INT16U  const  OSTCBPrioTblMax    = 31 + 1;          
  INT16U  const  OSTCBSize          = sizeof(OS_TCB);              
  INT16U  const  OSTicksPerSec      = 1000;
  INT16U  const  OSTimeTickHookEn   = 0;
  INT16U  const  OSVersionNbr       = 286u;
 ...
 
  ...
  INT16U  const  OSDataSize = sizeof(OSCtxSwCtr)
                                           ...
                                           + sizeof(OSEventTbl)
#line 136 "..\\..\\..\\OS\\uCOS-II\\Ports\\os_dbg.c"
                                           + sizeof(OSCPUUsage)
                                           + sizeof(OSIdleCtrMax)
                                           + sizeof(OSIdleCtrRun)
                                           + sizeof(OSStatRdy)
...
#line 156 "..\\..\\..\\OS\\uCOS-II\\Ports\\os_dbg.c"
                                           + sizeof(OSIntNesting)
