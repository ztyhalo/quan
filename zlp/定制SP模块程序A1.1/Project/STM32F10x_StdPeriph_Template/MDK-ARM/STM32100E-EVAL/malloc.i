...
__align(32) u8 mem1base[100*1024];													
__align(32) u8 mem2base[960 *1024] __attribute__((at(0X68000000)));					
__align(32) u8 mem3base[60 *1024] __attribute__((at(0X10000000)));					

u16 mem1mapbase[100*1024/32];													
u16 mem2mapbase[960 *1024/32] __attribute__((at(0X68000000+960 *1024)));	
u16 mem3mapbase[60 *1024/32] __attribute__((at(0X10000000+60 *1024)));	

const u32 memtblsize[3]={100*1024/32,960 *1024/32,60 *1024/32};	
const u32 memblksize[3]={32,32,32};					
const u32 memsize[3]={100*1024,960 *1024,60 *1024};							
