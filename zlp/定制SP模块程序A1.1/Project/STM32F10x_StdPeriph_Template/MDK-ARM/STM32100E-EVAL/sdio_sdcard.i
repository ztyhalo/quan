#line 1 "..\\..\\..\\Libraries\\SDIO\\sdio_sdcard.c"
...
#line 20 "..\\..\\..\\Libraries\\SDIO\\sdio_sdcard.c"
...
#line 21 "..\\..\\..\\Libraries\\SDIO\\sdio_sdcard.c"
...
#line 52 "..\\..\\..\\Libraries\\SDIO\\sdio_sdcard.c"
...
#line 78 "..\\..\\..\\Libraries\\SDIO\\sdio_sdcard.c"
...
{
  return (uint32_t)DMA_GetFlagStatus(((uint32_t)0x10002000));   
}
...
SD_Error SD_Init(void)
{
  ...
  SDIO_InitStructure.SDIO_ClockDiv       = ((uint8_t)0x01);
...
SD_Error SD_ReadBlock(uint8_t *readbuff, uint32_t ReadAddr, uint16_t BlockSize)
{
  ...
  ((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->DCTRL = 0x0;
...
#line 1213 "..\\..\\..\\Libraries\\SDIO\\sdio_sdcard.c"
...
#line 1462 "..\\..\\..\\Libraries\\SDIO\\sdio_sdcard.c"
  SDIO_ITConfig(((uint32_t)0x00000100), ENABLE);  
...
SD_Error SD_StopTransfer(void)
{
  ...
  ((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->ARG = 0x0;
  ((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->CMD = 0x44C;
...
SD_Error SD_Erase(uint32_t startaddr, uint32_t endaddr)
{
  ...
  maxdelay = 120000 / ((((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->CLKCR & 0xFF) + 2);
...
SD_Error SD_SendStatus(uint32_t *pcardstatus)
{
  ...
  ((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->ARG = (uint32_t) RCA << 16;
  ((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->CMD = 0x44D;
  ...
  *pcardstatus = ((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1;
  return(errorstatus);
}
...
static SD_Error CmdResp1Error(uint8_t cmd) 
{
  ...
  while (!(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA & (((uint32_t)0x00000001) | ((uint32_t)0x00000040) | ((uint32_t)0x00000004))))
  {
      timeout--;
	  if (timeout == 0)
	  {
  ...
  ((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->ICR = ((uint32_t)0x000005FF);	

  return (SD_Error)(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1 &  ((uint32_t)0xFDFFE008));		
}
