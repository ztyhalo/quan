...
void TargetInit(void)
{
  ...
  GPIOConfiguration();						
	...
	SD_DeInit();
  SD_Init();
	SD_EnableWideBusOperation(((uint32_t)0x00000800));
	I2C1_Init();
}
...
void GPIOConfiguration(void)
{
	 ...
	 RCC_APB2PeriphClockCmd(((uint32_t)0x00000004)
	 						|((uint32_t)0x00000008)
	 						|((uint32_t)0x00000010)
							|((uint32_t)0x00000020) 
							| ((uint32_t)0x00000040) 
...
void ReadBoardNumber()
{
	  ...
	  if((sw3>9)|(sw3<=0)){ sw3=0;}
	  BOARDNUMBER = sw3 +sw2*10+sw1*100;
}
...
uint8_t i2c_CheckDevice(uint8_t _Address)
{
	...
	if (((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->IDR & ((uint16_t)0x0080)) != 0) && ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->IDR & ((uint16_t)0x0040)) != 0))
	{
		I2C_GenerateSTART(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), ENABLE);		 

		 
		I2C_Send7bitAddress(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), _Address,((uint8_t)0x00));
		ucAck = I2C_ReceiveData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)));	 
