...
void Usart_Gpio(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000020)|((uint32_t)0x00000004)|((uint32_t)0x00000001), ENABLE);
	RCC_APB2PeriphClockCmd(((uint32_t)0x00004000), ENABLE);
	RCC_APB1PeriphClockCmd(((uint32_t)0x00020000)|((uint32_t)0x00040000), ENABLE);
	...
	GPIO_PinRemapConfig(((uint32_t)0x00140030), ENABLE);
...
void USART1_puts(char *str)
{
   ...
   USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0040));
   while(*str)
   {
...
void USART1_putc(char c)
{
	...
	USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0040));
	USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),c); 
	while(USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0040)) == RESET);
}
...
void USART2_puts(char *str)
{
   ...
   USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0040));
   while(*str)
   {
	   USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)),*str++);
...
void USART3_puts(char *str)
{
   ...
   USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0040));
   while(*str)
   {
	   USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)),*str++);
