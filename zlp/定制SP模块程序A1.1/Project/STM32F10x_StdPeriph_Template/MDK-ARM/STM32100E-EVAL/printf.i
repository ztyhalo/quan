#line 1 "..\\..\\..\\Libraries\\SDIO\\printf.c"
...
#line 35 "..\\..\\..\\Libraries\\SDIO\\printf.c"
#line 1 "..\\..\\..\\Libraries\\SDIO\\printf.h"
...
#line 36 "..\\..\\..\\Libraries\\SDIO\\printf.c"
...
#line 38 "..\\..\\..\\Libraries\\SDIO\\printf.c"
...
#line 52 "..\\..\\..\\Libraries\\SDIO\\printf.c"
...
void PFUSARTInit()
{
	...
	USART_DeInit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)));                                   
...
int fputc(int ch, FILE *f)
{
    ...
    USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), (u8) ch);
...
u32 SerialKeyPressed(u8 *key)
{
  ...
  if (USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0020)) != RESET)	 
  {
    *key = (u8)((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->DR & 0xFF;
    return 1;
  }
  else                 
  {
