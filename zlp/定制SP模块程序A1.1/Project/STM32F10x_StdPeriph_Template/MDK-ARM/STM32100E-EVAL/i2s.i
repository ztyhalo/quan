...
{ 
  ...
  SPI_I2S_DeInit(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)));
	...
	I2S_InitStructure.I2S_MCLKOutput=((uint16_t)0x0200);
	I2S_InitStructure.I2S_AudioFreq=((uint32_t)44100);
	I2S_InitStructure.I2S_CPOL=I2S_Clock_Polarity;
	I2S_Init(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)),&I2S_InitStructure);

 
	SPI_I2S_DMACmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)),((uint16_t)0x0002),ENABLE);
  I2S_Cmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)),ENABLE);
...
{  
  ...
  RCC_APB1PeriphClockCmd(((uint32_t)0x00004000), ENABLE); 
	...
	DMA_DeInit(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0408)));
	DMA_SetCurrDataCounter(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0408)), 0);
	DMA_ClearFlag(((uint32_t)0x10000002) | ((uint32_t)0x10000008) | ((uint32_t)0x10000004) | ((uint32_t)0x10000001));
	DMA_InitStructure.DMA_PeripheralBaseAddr = (u32)(&((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800))->DR);                 
	...
	DMA_Init(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0408)), &DMA_InitStructure);
	DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0408)), ENABLE);  
		
	SPI_I2S_DMACmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((uint16_t)0x0001), ENABLE);
	SPI_I2S_DMACmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((uint16_t)0x0002),ENABLE);
	DMA_ITConfig(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0408)), ((uint32_t)0x00000002), ENABLE); 
...
{      
	if(DMA_GetITStatus(((uint32_t)0x10000002))==SET)
	{ 
	DMA_ClearFlag(((uint32_t)0x10000002));
      	i2s_tx_callback();	
	}   											 
}  
...
void I2S_Play_Stop(void)
{   
		DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0408)),DISABLE);
