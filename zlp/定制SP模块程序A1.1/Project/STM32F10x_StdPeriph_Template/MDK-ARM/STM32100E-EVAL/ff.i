#line 1 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 99 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
#line 1 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.h"
...
#line 12 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.h"
...
#line 60 "..\\..\\..\\Libraries\\FATFS\\src\\diskio.h"
...
#line 100 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 122 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"


 
#line 135 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"




 
#line 151 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"



 

#line 173 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"

#line 349 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 376 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"


 
#line 386 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 435 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"

#line 457 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 502 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"

#line 513 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 541 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
	while (cnt--)
		*d++ = *s++;
}
...
#line 602 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 713 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 964 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
			clst = nxt;	 
		}
	}
...
#line 1059 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 1596 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 1654 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
)
{
	...
	*path = &p[si];						 
	cf = (w < ' ') ? 0x04 : 0;		 
#line 1718 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
	while (di) {						 
		w = lfn[di-1];
		if (w != ' ' && w != '.') break;
		di--;
...
#line 1871 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
}
...
)
{
	...
	if (dj->sect) {
		...
		for (i = 0; i < 8; i++) {	 
			...
			if (2 && (nt & 0x08) && (((c)>= 'A')&&((c)<= 'Z'))) c += 0x20;
#line 1906 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
			*p++ = c;
		}
		if (dir[8] != ' ') {		 
			*p++ = '.';
			for (i = 8; i < 11; i++) {
				c = dir[i];
				if (c == ' ') break;
				if (2 && (nt & 0x10) && (((c)>= 'A')&&((c)<= 'Z'))) c += 0x20;
#line 1920 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
				*p++ = c;
			}
		}
		fno->fattrib = dir[11];				 
...
#line 1979 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
	if (*path == '/' || *path == '\\')	 
		path++;
	dj->sclust = 0;						 
...
)
{
	...
	*rfs = fs;							 
	...
	fs->winsect = 0;		 
	fs->wflag = 0;
#line 2206 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
)
{
	...
	if (rfs) {
#line 2271 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
		rfs->fs_type = 0;		 
	}
...
#line 2399 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
		;
		...
		if ((fp->fptr % 512U) == 0) {	 
			...
			if (cc) {						 
				...
				if (disk_write(fp->fs->drv, wbuff, sect, (BYTE)cc) != RES_OK)
					{ fp->flag |= 0x80; return FR_DISK_ERR; };
#line 2596 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
				if (fp->dsect - sect < cc) {  
...
#line 2610 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
			if (fp->dsect != sect) {		 
				if (fp->fptr < fp->fsize &&
		...
		wcnt = 512U - ((UINT)fp->fptr % 512U); 
		if (wcnt > btw) wcnt = btw;
#line 2626 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 2709 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
	res = f_sync(fp);		 
#line 2724 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 2853 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 2930 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
...
#line 3615 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"



#line 3926 "..\\..\\..\\Libraries\\FATFS\\src\\ff.c"
