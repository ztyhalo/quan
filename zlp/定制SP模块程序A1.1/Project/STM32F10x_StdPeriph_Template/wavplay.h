...
#define I2S_TX_DMA_BUF_SIZE    4096		//定义TX DMA 数组大小(播放192Kbps@24bit的时候,需要设置8192大才不会卡)
...
u32 wav_buffill(u8 *buf,u16 size,u8 bits);
u8 wav_play_start(u8* fname);
u8 wav_play_stop(void);
void StartPlay_Init(void);


extern u8 audiofilm[1024];
extern u8 audiobuf1[WAV_I2S_TX_DMA_BUFSIZE];
extern u8 audiobuf2[WAV_I2S_TX_DMA_BUFSIZE];
