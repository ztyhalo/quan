...
OS_CPU_SR_Save
    MRS     R0, PRIMASK     ; Set prio int mask to mask all (except faults) //中断屏蔽寄存器组
    CPSID   I	            ; //关中断 CPSID I ;PRIMASK=1， ;关中断CPSIE I ;PRIMASK=0， ;开中断CPSID F ;FAULTMASK=1, ;关异常CPSIE F ;FAULTMASK=0 ;开异常
    BX      LR
