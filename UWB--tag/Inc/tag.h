...
#define USART_FRAME_DATA_IDX				0x04	//帧数据索引
#define USART_FRAME_CHIPID_IDX			0x04	//ChipID索引
#define USART_FRAME_MACID_IDX				0x0C	//MAC ID索引
#define USART_FRAME_NAME_IDX				0x0E	//Name索引
